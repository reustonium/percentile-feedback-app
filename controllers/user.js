...
exports.postUpdateProfile = function(req, res, next) {
  User.findById(req.user.id, function(err, user) {
    ...
    rescueTime.validKey(req.body.rescueTimeKey, function(valid){
      if(!valid){
        req.flash('errors', {msg: 'Invalid RescueTime Key'});
        res.redirect('/account');
      } 
      else {
        user.profile.validRTKey = true;
        user.save(function(err) {
          if (err) return next(err);
...
exports.postReset = function(req, res, next) {
  ...
  async.waterfall([
    ...
    function(user, done) {
      ...
      var mailOptions = {
        to: user.email,
        from: 'andrew.ruestow@gmail.com',
        subject: 'Your quantifyToday password has been changed',
        text: 'Hello,\n\n' +
  ...
  async.waterfall([
    ...
    function(token, user, done) {
      ...
      var mailOptions = {
        to: user.email,
        from: 'andrew.ruestow@gmail.com',
        subject: 'Reset your password on quantifyToday',
